...
//        获取当前登录用户
        ...
        back = (ImageView) findViewById(R.id.layoutmyfbImageView1);
        list = (ListView) findViewById(R.id.myfblist);
        ivEmpty = (ImageView) findViewById(R.id.iv_myfabu);
        swiperLayout = (SwipeRefreshLayout)findViewById(R.id.layoutmyfbSwipeRefreshLayout1);
...
//             简化处理   浏览量+1
                ...
                //跳转至帖子详情页
                intent = new Intent(MyPostActivity.this, PostDetailActivity.class);
...
//        同时获取帖子的作者信息
        ...
        query.setLimit(500);
        query.addWhereMatchesQuery("author","_User",inner);
...
//                列表数据加载完成
                        list.setAdapter(new MyPostActivity.ItemListAdapter());
                    }
                }else {
                    ivEmpty.setVisibility(View.VISIBLE);
                }
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final MyPostActivity.ItemListAdapter.ViewHolder viewHolder;
            if (convertView == null) {
                viewHolder = new MyPostActivity.ItemListAdapter.ViewHolder();
                ...
                viewHolder = (MyPostActivity.ItemListAdapter.ViewHolder) convertView.getTag();
            }
            ...
            if (topic.getPicture() == null) {
                ...
                Picasso.with(MyPostActivity.this)
            ...
            viewHolder.likes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dian.update(new UpdateListener() {
                        @Override
                        public void done(BmobException e) {
                            Toast.makeText(MyPostActivity.this,"你已成功点赞",Toast.LENGTH_SHORT).show();
