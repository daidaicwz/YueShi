...
//        密码修改
        layout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ViewGroup layout = (ViewGroup) UserProfileActivity.this.getLayoutInflater().inflate(R.layout.dialog_reset_passwords, null);
                EditText edit1 = (EditText) layout.findViewById(R.id.old_password);
                EditText edit2 = (EditText) layout.findViewById(R.id.new_password);
                Button button1 = (Button) layout.findViewById(R.id.dialog_reset1);
                Button button2 = (Button) layout.findViewById(R.id.dialog_reset2);
                ...
                button2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (str1.equals("")||str2.equals("")) {
                            ...
                            user = new MyUser();
                            user = BmobUser.getCurrentUser(MyUser.class);
                            BmobUser.updateCurrentUserPassword(str1, str2, new UpdateListener() {
                                @Override
                                public void done(BmobException e) {
                                    if (e == null) {
                                        Toast.makeText(UserProfileActivity.this, "密码修改成功", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(UserProfileActivity.this, "旧密码输入错误", Toast.LENGTH_SHORT).show();
                                    }
                                    dia.dismiss();
                                }
                            });
