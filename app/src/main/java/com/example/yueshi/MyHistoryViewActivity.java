...
public class MyHistoryViewActivity extends AppCompatActivity {
...
//        获取当前登录用户
        ...
        back = (ImageView) findViewById(R.id.layoutmyhvImageView1);
        list = (ListView) findViewById(R.id.myhvlist);
        ivEmpty = (ImageView) findViewById(R.id.iv_mylishi);
        swiperLayout = (SwipeRefreshLayout)findViewById(R.id.layoutmyhvSwipeRefreshLayout1);
...
//             简化处理   浏览量+1
                ...
                //跳转至帖子详情页
                intent = new Intent(MyHistoryViewActivity.this, PostDetailActivity.class);
...
//        同时获取帖子的作者信息
        ...
        query.setLimit(500);
        query.addWhereMatchesQuery("view","_User",inner);
...
//                列表数据加载完成
                        list.setAdapter(new MyHistoryViewActivity.ItemListAdapter());
                    }
                }else {
                    ivEmpty.setVisibility(View.VISIBLE);
                }
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final MyHistoryViewActivity.ItemListAdapter.ViewHolder viewHolder;
            if (convertView == null) {
                viewHolder = new MyHistoryViewActivity.ItemListAdapter.ViewHolder();
                ...
                viewHolder = (MyHistoryViewActivity.ItemListAdapter.ViewHolder) convertView.getTag();
            }
            ...
            if (topic.getPicture() == null) {
                ...
                Picasso.with(MyHistoryViewActivity.this)
            ...
            viewHolder.likes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dian.update(new UpdateListener() {
                        @Override
                        public void done(BmobException e) {
                            Toast.makeText(MyHistoryViewActivity.this,"你已成功点赞",Toast.LENGTH_SHORT).show();
