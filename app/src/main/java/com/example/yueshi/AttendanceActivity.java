...
import com.example.yueshi.bean.Attendance;
...
//                              更新用户信息
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            attendance = mPostlist.get(position);

            Boolean st = attendance.getState();
            //如果为true则认证
            if (st == true) {
            ...
            viewHolder.time.setText(attendance.getTime());
            viewHolder.name.setText(attendance.getUser().getName());
            return convertView;
        }
