...
public class CommunityFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_community_2, container, false);
        return view;
    }
...
//        获取当前登录用户
        ...
        list = getActivity().findViewById(R.id.fragment2list);
        ivEmpty = getActivity().findViewById(R.id.iv_empty2);
        swiperLayout = getActivity().findViewById(R.id.fragment2SwipeRefreshLayout1);
...
//             简化处理   浏览量+1
    ...
    private void getTopicData() {
        ...
        query.addWhereEqualTo("type","琐事杂谈");
...
//                列表数据加载完成
                        list.setAdapter(new CommunityFragment2.ItemListAdapter());
                    }
                }else {
                    ivEmpty.setVisibility(View.VISIBLE);
                }
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final CommunityFragment2.ItemListAdapter.ViewHolder viewHolder;
            if (convertView == null) {
                viewHolder = new CommunityFragment2.ItemListAdapter.ViewHolder();
                ...
                viewHolder = (CommunityFragment2.ItemListAdapter.ViewHolder) convertView.getTag();
            }
