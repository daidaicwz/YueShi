...
import com.example.yueshi.PostDetailActivity;
...
public class CommunityFragment4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_community_4, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Bmob.initialize(getActivity(), "0f9fca80b537d756e72c2a70c3420f92");
        user = new MyUser();
//        获取当前登录用户
        user = BmobUser.getCurrentUser(MyUser.class);
        getTopicData();

        list = getActivity().findViewById(R.id.fragment4list);
        ivEmpty = getActivity().findViewById(R.id.iv_empty4);
        swiperLayout = getActivity().findViewById(R.id.fragment4SwipeRefreshLayout1);
...
//             简化处理   浏览量+1
    ...
    private void getTopicData() {
        ...
        query.addWhereEqualTo("type","美文分享");
...
//                列表数据加载完成
                        list.setAdapter(new CommunityFragment4.ItemListAdapter());
                    }
                }else {
                    ivEmpty.setVisibility(View.VISIBLE);
                }
    ...
    class ItemListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final CommunityFragment4.ItemListAdapter.ViewHolder viewHolder;
            if (convertView == null) {
                viewHolder = new CommunityFragment4.ItemListAdapter.ViewHolder();
                ...
                viewHolder = (CommunityFragment4.ItemListAdapter.ViewHolder) convertView.getTag();
            }
            ...
            viewHolder.likes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dian.update(new UpdateListener() {
                        @Override
                        public void done(BmobException e) {
                            Toast.makeText(getActivity(),"你已成功点赞",Toast.LENGTH_SHORT).show();
