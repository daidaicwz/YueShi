...
public class CommunityFragment1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_community_1, container, false);
        return view;
    }
...
//        FloatingActionButton fab = getActivity().findViewById(R.id.fabtn_post);
        list = getActivity().findViewById(R.id.fragment1list);
        ivEmpty = getActivity().findViewById(R.id.iv_empty1);
        swiperLayout = getActivity().findViewById(R.id.fragment1SwipeRefreshLayout1);
...
//             简化处理   浏览量+1
    ...
    private void getTopicData() {
        ...
        query.addWhereEqualTo("type","日常分享");
